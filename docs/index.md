...
| | |
|---|---|
| **Instructor** | [Fabio Giglietto](mailto:fabio.giglietto@uniurb.it) |
...
1. **[Setup your environment](setup.html)** — Install R, RStudio, and Claude Code
2. **[Download materials](materials.html)** — Get scripts, data, and resources
3. **[Learn to use Claude Code](claude-code.html)** — Tips for effective AI-assisted learning
